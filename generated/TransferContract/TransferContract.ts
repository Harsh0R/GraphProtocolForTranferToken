...
export class TransferContract extends ethereum.SmartContract {
  static bind(address: Address): TransferContract {
    return new TransferContract("TransferContract", address);
  }
